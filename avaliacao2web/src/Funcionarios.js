  ...
  return (
    <div className="funcionarios">
      {data.map(funcionario => (
        <div className="card" key={funcionario.id}>
          <img src={funcionario.foto} alt="Foto" className="foto" />
          <h2>{funcionario.nome}</h2>
          <p className="propriedade">{funcionario.subobjeto.propriedade1}</p>
          <p className="propriedade">{funcionario.subobjeto.propriedade2}</p>
          <a href={`mailto:${funcionario.email}`} className="email">{funcionario.email}</a>
        </div>
      ))}
    </div>
  );
